...
while [[ "$current_date" < "$stopped_before_date" ]]; do
    ...
    ripe-atlas measurement-search --type ping --af 4 --search $ip_address --started-after $current_date --started-before $next_date --ids-only --limit 1000 >> all.measurement.ids
